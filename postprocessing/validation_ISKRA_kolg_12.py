...
path_verification = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\kolganov_12m\validation'
...
if QUBIQ:
    ...
    if GAS:
        ...
        # validation 1st
        path_qubiq_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\kolganov_12m\run\slices\combined_results.csv'
...
y_limits = {
    ...
    'gas_temperature': [0, 1500],
    'gas_pressure': [0, 300000],
    'gas_velocity': [0, 800],
    'gas_Y_air': [0, 1.1],
    'gas_Y_cp': [0, 1.1],
    'gas_Y_gpg': [0, 0.1],
    'gas_mass_flow_rate': [0, 7]
}
...
mfr_fuel_gas_in = 0.124
mfr_oxidizer_in = 5.782
