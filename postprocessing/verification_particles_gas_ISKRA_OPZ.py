...
verify_sources = [FLUENT, QUBIQ]
number_of_sources = sum(verify_sources)

path_verification = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\Verification\comb_eff_fuel_only_low'
...
if QUBIQ:
    if PARTICLES:
        # Пути к директориям
        # path_qubiq_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\LES_HOT_LOW\part\particles_time_0.217373_averaged.csv'
        # path_qubiq_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\LES_HOT_LOW\part\tracks\averaged_data_by_time.csv'
        # path_qubiq_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\LES_HOT_HIGH\part\particles_time_0.459141_averaged.csv'

        # OPZ high
        path_qubiq_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\high\part\tracks\averaged_data_by_time.csv'


        # Формируем датафреймы
        # df_qubiq_particles_01 = pd.read_csv(path_qubiq_particles_01, sep='\s+', index_col='X')
        df_qubiq_particles_01 = pd.read_csv(path_qubiq_particles_01, sep=',', index_col='X')
    if GAS:
        # Пути к директориям
        # path_qubiq_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\LES\data_averaged_QUBIQ_3D.csv'

        # OPZ high
        # path_qubiq_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\high\run\slices\combined_results.csv'
        ...
        # OPZ low onlygas
        path_qubiq_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\low_onlygas\run\slices\combined_results.csv'

        # OPZ high onlygas
        # path_qubiq_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\QUBIQ\high_onlygas\run\slices\combined_results.csv'
...
if FLUENT:
    if PARTICLES:
        ...
        # path_fluent_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\03_LES_analytic\part\tracks\averaged_data_by_time.csv'
        ...
        # OPZ high
        # path_fluent_particles_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\06_LES_high_regenerated\2nd_mom_time\parts\tracks\averaged_data_by_time.csv'

        # OPZ high changed OPZ coeff
        path_fluent_particles_01 = r'E:\YASIM\VORON_TEMP\2026_12_Iskra_OPZ\high_OPZ_b08\tracks\averaged_data_by_time.csv'

        # Формируем датафреймы
        # df_fluent_particles_01 = pd.read_csv(path_fluent_particles_01, index_col='CoordinateX')
        df_fluent_particles_01 = pd.read_csv(path_fluent_particles_01, index_col='X')

    if GAS:
        # OPZ low
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\02_LES\data_averaged_FLUENT_3D.csv'
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\03_LES_analytic\run_long\slices\combined_results.csv'

        # OPZ low onlygas
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\low_onlygas\run\slices\combined_results.csv'

        # OPZ low onlygas mc2
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\low_onlygas_mc2\run\slices\combined_results.csv'

        # OPZ low onlygas ed
        path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\low_onlygas_ed\run\slices\combined_results.csv'
        ...
        # OPZ high onlygas
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\high_onlygas\run\slices\combined_results.csv'

        # OPZ high onlygas ed
        # path_fluent_gas_01 = r'D:\YASIM\VORON\2026_12_Iskra_OPZ\FLUENT\high_onlygas_ed\run\slices\combined_results.csv'
...
y_limits = {
    ...
    'gas_temperature': [500, 2750],
    'gas_pressure': [0, 1400000],
    'gas_velocity': [0, 1000],
    'gas_Y_air': [0, 1],
    'gas_Y_cp': [0, 1],
    'gas_Y_gpg': [0, 0.1],
    'gas_mass_flow_rate': [0, 9]
}
...
# iskra OPZ low onlygas
mfr_fuel_particles_in = 0
mfr_fuel_gas_in = 0.9
mfr_oxidizer_in = 6.58
...
# iskra OPZ high onlygas
# mfr_fuel_particles_in = 0
# mfr_fuel_gas_in = 0.21
# mfr_oxidizer_in = 1.27
...
# if QUBIQ and PARTICLES:
    # df_qubiq_particles_01['diameter'] = df_qubiq_particles_01['diameter']*1e6


def combustion_efficiency(mass_stoichiometric_ratio, mfr_fuel_in, mfr_oxidizer_in, mfr_products, mfr_oxidizer, mfr_fuel, Y_products, Y_oxidizer, Y_fuel, idx):
    x_fuel_injection = 0
    ...
    if alpha >= 1:
        ...
        mfr_oxidizer_left = mfr_oxidizer_in * (1 - 1/alpha)
        print(f'mfr_oxidizer_can_react = {mfr_oxidizer_can_react}, mfr_oxidizer_left={mfr_oxidizer_left}, mfr_oxidizer_in={mfr_oxidizer_in}')
    else:
    ...
    print(f'Y_oxidizer_can_react = {Y_oxidizer_can_react}, Y_oxidizer_left={Y_oxidizer_left}')
    print(f'Y_fuel_can_react = {Y_fuel_can_react}, Y_fuel_left={Y_fuel_left}')
    print(f'Y_products_max = {Y_products_max}')
...
if FLUENT and GAS:
    ...
    for idx, row in df_fluent_gas_01.iterrows():
        ...
        alpha, etta_mfr_products, etta_mfr_oxidizer, etta_mfr_fuel, etta_Y_products, etta_Y_oxidizer, etta_Y_fuel = combustion_efficiency(
                    ...
                    Y_products, Y_oxidizer, Y_fuel, idx
                )
...
if GAS:
    ...
    plot_result(f"{pic_base_name}gas_etta_01_fuel", x_t_label, r'$\eta$',
                (df_qubiq_gas_01, ['etta_mfr_fuel', 'etta_Y_fuel'], [style_Q]*2, ['СПК «ГиперКуб-ГРАФ» - полнота по расходу топлива', 'СПК «ГиперКуб-ГРАФ» - полнота по массовой доле топлива'], y_limits['combustion_efficiency'], colors),
                (df_fluent_gas_01, ['etta_mfr_fuel', 'etta_Y_fuel'], [style_F] * 2,
                 ['ПК «ANSYS Fluent» - полнота по расходу топлива', 'ПК «ANSYS Fluent» - полнота по массовой доле топлива'], y_limits_default, colors),
                GOST=GOST, x_limits=(x_limit_low, x_limit_high), swap_axes=False, line_width=line_width, horizontal_lines=[1])

    plot_result(f"{pic_base_name}gas_etta_01_fuel-2", x_t_label, r'$\eta$',
                (df_qubiq_gas_01, ['etta_mfr_fuel'], [style_Q], ['СПК «ГиперКуб-ГРАФ» - полнота по расходу топлива'], y_limits['combustion_efficiency'], colors),
                (df_fluent_gas_01, ['etta_mfr_fuel'], [style_F],
                 ['ПК «ANSYS Fluent» - полнота по расходу топлива'], y_limits_default, colors),
                GOST=GOST, x_limits=(x_limit_low, x_limit_high), swap_axes=False, line_width=line_width, horizontal_lines=[1])
