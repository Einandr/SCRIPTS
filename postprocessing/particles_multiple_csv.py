...
from postprocessing.utils import plot_result, create_animation_tracks
...
match solver:
    ...
    case Solver.QUBIQ:
        input_dir = r'D:\YASIM\VORON\2026_15_Spalding_Combustion\QUBIQ\T1000K_freq10000_comb_v0.0ms_pmfr0.00000179\part'
    case _:
...
files = glob(os.path.join(input_dir, files_extension))
all_data = []
...
if animate_tracks:
    ...
    config_diameter = [
        (max_points_track_group, ['diameter'], [style_instant], ['для конкретного трека'], y_limits['particle_Diameter'], colors),
    ]
